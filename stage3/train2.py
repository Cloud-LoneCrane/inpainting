...
if __name__ == '__main__':
    data_prefix = "/home/SuXiangDong/GPU20StuA/wangmeng/data"
    ...
    parser.add_argument("--save_result", default=False, type=bool, help="whether save test result")
    ...
    parser.add_argument("--stage", default=2, choices=[1, 2, 3, 4], type=int)     # 消融实验：验证的是第几组消融实验
