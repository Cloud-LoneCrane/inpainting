...
from PENNet.core.inception import InceptionV3
...
def get_activations(images, model, batch_size=64, dims=2048, cuda=True, verbose=False):
  ...
  -- modules       : Instance of inception modules
  ...
  for i in range(n_batches):
    ...
    # If modules output is not scalar, apply global spatial average pooling.
