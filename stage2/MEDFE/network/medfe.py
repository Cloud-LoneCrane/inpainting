...
from MEDFE.network.branch import Branch
from MEDFE.network.conv_unit import ConvUnit, DeConvUnit
from MEDFE.network.res_block import ResBlock
from MEDFE.network.bpa import Bpa
...
class MEDFE(nn.Module):
    ...
    """
    def __init__(self, in_channels, batch_norm=True, use_bpa=False, use_branch=True, use_res=True, branch_channels=512, channels=64):
        """
        ...
        # ENCODER
        self.conv1 = ConvUnit(in_channels, channels, (4, 4), stride=(2, 2), padding=(1, 1))
