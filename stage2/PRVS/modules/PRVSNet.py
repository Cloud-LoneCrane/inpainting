import math
from PRVS.modules.partialconv2d import PartialConv2d
from PRVS.modules.PConvLayer import PConvLayer
from PRVS.modules.VSRLayer import VSRLayer
import PRVS.modules.Attention as Attention
import torch
...
class PRVSNet(BaseNetwork):
    def __init__(self, layer_size=8, input_channels=3, output_channels=3, att=False):
        super().__init__()
        self.layer_size = layer_size
        self.enc_1 = VSRLayer(input_channels, 64, kernel_size=7)
        ...
        self.output = nn.Conv2d(128, output_channels, 1)
    ...
    def forward(self, input, input_mask, input_edge):
        ...
        for i in range(1, self.layer_size + 1):
            ...
            if i not in [1, 2]:
                ...
                h_dict[h_key], h_mask_dict[h_key], edge = getattr(self, l_key)(h_dict[h_key_prev],
                                                                               h_mask_dict[h_key_prev], edge)
