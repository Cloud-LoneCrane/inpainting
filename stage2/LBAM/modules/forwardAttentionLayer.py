...
from LBAM.modules.ActivationFunction import GaussActivation, MaskUpdate
...
class ForwardAttentionLayer(nn.Module):
    def __init__(self, inputChannels, outputChannels, kernelSize, stride, padding, dilation=1, groups=1, bias=False):
        ...
        if inputChannels < 7:
            self.maskConv = nn.Conv2d(1, outputChannels, kernelSize, stride, padding, dilation, groups, bias)
        else:
